...
boolean hun = false;
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    ...
    if (results != null && results.size() >= 3) {
      ...
      First_Title=recognition.getTitle();
      if (recognition != null) {
        if (recognition.getTitle() != null)
          ...
          {recognitionTextView.setText("");
            ...
            button.setOnClickListener(new View.OnClickListener() {
              ...
              @Override
              public void onClick(View view) {
                Toast toast = Toast.makeText(getApplicationContext(), "인식을 할 수 없습니다!", Toast.LENGTH_SHORT);
                toast.setGravity(Gravity.CENTER,Gravity.CENTER_HORIZONTAL,Gravity.CENTER_VERTICAL);
                handler.postDelayed(toast::cancel, 600 );
                toast.show();
              }
            });}
        if (First_Title.equals("성 바실리 대성당")) {
          value = 0;

        }
        else if (First_Title.equals("이공관")) {
          value = 1;

        }
        else if (First_Title.equals("산 마르코 광장")) {
          value = 2;

        }
        else if (First_Title.equals("에펠탑")) {
          value = 3;

        }
        else if (First_Title.equals("콜로세움")) {
          value = 4;
        ...
        if (recognition.getConfidence() != null)
          ...
          {recognitionValueTextView.setText(
                    String.format("", (100 * recognition.getConfidence())) + "");
            Button button = (Button) findViewById(R.id.button);
            button.setOnClickListener(new View.OnClickListener() {
